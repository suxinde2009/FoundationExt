...
public class GCDTimer {
    ...
    private var handler: GCDTimerHandler
...
//MARK: Count Down
public class GCDCountDownTimer {
    ...
    private let handler: (GCDCountDownTimer, _ leftTimes: Int) -> Void
    
    public init(
        interval: DispatchTimeInterval,
        times: Int,
        queue: DispatchQueue = .main,
        handler:  @escaping (GCDCountDownTimer, _ leftTimes: Int) -> Void
    ) {

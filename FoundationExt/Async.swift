...
public struct AsyncBlock<In, Out> {
     ...
     */
    @discardableResult
    public static func main<O>(after seconds: Double? = nil,
                               _ block: @escaping () -> O) -> AsyncBlock<Void, O> {
        AsyncBlock.async(
            after: seconds,
            block: block,
            queue: .main
    ...
    private static func async<O>(after seconds: Double? = nil,
                                 block: @escaping () -> O, queue: GCD) -> AsyncBlock<Void, O> {
     ...
     */
    @discardableResult
    public func main<O>(after seconds: Double? = nil,
                        _ chainingBlock: @escaping (Out) -> O) -> AsyncBlock<Out, O> {
        chain(
            after: seconds,
            block: chainingBlock,
            queue: .main
     ...
     */
    @discardableResult
    public func custom<O>(queue: DispatchQueue, after seconds: Double? = nil,
                          _ chainingBlock: @escaping (Out) -> O) -> AsyncBlock<Out, O> {
        chain(
            after: seconds,
            block: chainingBlock,

...
public enum DiskStorage {
    ...
    public class Backend<T: DataTransformable> {
        ...
        let maybeCachedCheckingQueue = DispatchQueue(label: "com.skyprayer.DiskStorage.maybeCachedCheckingQueue")
        ...
        private func prepareDirectory() throws {
            ...
            do {
                ...
                throw StorageError.cacheError(reason: .cannotCreateDirectory(path: path, error: error))
            }
        }
            ...
            writeOptions: Data.WritingOptions = []) throws
        {
            guard storageReady else {
                throw StorageError.cacheError(reason: .diskStorageIsNotReady(cacheURL: directoryURL))
            }
            ...
            do {
                ...
                throw StorageError.cacheError(reason: .cannotConvertToData(object: value, error: error))
            }
            ...
            extendingExpiration: ExpirationExtending) throws -> T?
        {
            ...
            do {
                ...
                throw StorageError.cacheError(reason: .cannotLoadDataFromDisk(url: fileURL, error: error))
            }
        }
        ...
        func allFileURLs(for propertyKeys: [URLResourceKey]) throws -> [URL] {
            ...
            {
                throw StorageError.cacheError(reason: .fileEnumeratorCreationFailed(url: directoryURL))
            }
            
            guard let urls = directoryEnumerator.allObjects as? [URL] else {
                throw StorageError.cacheError(reason: .invalidFileEnumeratorContent(url: directoryURL))
            }
            return urls
        }
...
extension DiskStorage {
    struct Creation {
        ...
        init(_ config: Config) {
            ...
            cacheName = "com.skyprayer.DiskStorage.FileCache.\(config.name)"
